...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Edwin";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `Nuestro proximo mes es en: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
